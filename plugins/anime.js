...
await conn.sendMessage(from,{image:{url: `https://i.ibb.co/5XDw3TT/Manul-Ofc-X.jpg`},caption:dec},{quoted:mek});
...
await conn.sendMessage(from,{image:{url: `https://i.ibb.co/fxnMYQ6/Manul-Ofc-X.jpg`},caption:dec},{quoted:mek});
